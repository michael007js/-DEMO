package com.sss.framework.CustomWidget.bilibili_search_box.db;
...
public class SearchHistoryDB extends SQLiteOpenHelper {
    ...
    public SearchHistoryDB(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        ...
        if (EmptyUtils.isNotEmpty(AppUtils.getAppName(context,null))){
            DB_NAME= AppUtils.getAppName(context,null);
        }
