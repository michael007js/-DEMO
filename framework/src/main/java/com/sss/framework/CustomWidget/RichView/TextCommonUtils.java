...
import com.sss.framework.CustomWidget.RichView.listener.ITextViewShow;
...
//            LogUtils.e(index+listUser.get(i).getUser_name());
...
//                LogUtils.e(hadAt+"------"+matchEnd+"-"+lenght+"------"+index+"-"+lenght);
