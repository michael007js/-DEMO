 ...
 * 滑到头部或尾部可伸缩放大效果
 *
 * https://blog.csdn.net/KokJuis/article/details/62046834
...
public class BounceZoomScrollView extends ScrollView {
    ...
    OnBounceZoomScrollViewCallBack onBounceZoomScrollViewCallBack;
    ...
    public void setOnBounceZoomScrollViewCallBack(OnBounceZoomScrollViewCallBack onBounceZoomScrollViewCallBack) {
        this.onBounceZoomScrollViewCallBack = onBounceZoomScrollViewCallBack;
    }
    ...
    protected void onOverScrolled(int scrollX, int scrollY, boolean clampedX, boolean clampedY) {
        ...
        LogUtils.e(scrollX + "---" + scrollY + "---" + clampedX + "---" + clampedY);
        if (onBounceZoomScrollViewCallBack != null) {
            onBounceZoomScrollViewCallBack.onScrollX(scrollX, mScaling,upDownSlide,clampedX);
            onBounceZoomScrollViewCallBack.onScrollY(scrollY,mScaling,upDownSlide, clampedY);
        }
    }
    ...
    public interface OnBounceZoomScrollViewCallBack{
        void onScrollX(int x,boolean isScaling,boolean upDownSlide,boolean isToTop);

        void onScrollY(int y,boolean isScaling,boolean upDownSlide,boolean isToBottom);
    }
