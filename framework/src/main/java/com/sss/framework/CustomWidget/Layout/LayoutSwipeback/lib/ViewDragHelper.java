...
package com.sss.framework.CustomWidget.Layout.LayoutSwipeback.lib;
...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        /**
         * Called when the captured view'类似微博的emoji表情、@人、话题等 position changes as the result of a
         * drag or settle.
         *
         ...
         *
         * @param edgeFlags A combination of edge flags describing the edge(类似微博的emoji表情、@人、话题等)
         *                  currently touched
         * @param pointerId ID of the pointer touching the described edge(类似微博的emoji表情、@人、话题等)
         * @see #EDGE_LEFT
         * @see #EDGE_TOP
         * @see #EDGE_RIGHT
         * @see #EDGE_BOTTOM
        ...
        /**
         * Return the magnitude of a draggable child view'类似微博的emoji表情、@人、话题等 horizontal range of
        ...
        /**
         * Return the magnitude of a draggable child view'类似微博的emoji表情、@人、话题等 vertical range of
         * motion in pixels. This method should return 0 for views that cannot
         * move vertically.
         *
         * @param child Child view to check
        ...
        /**
         * Called when the user'类似微博的emoji表情、@人、话题等 input indicates that they want to capture the
     ...
     *                    ViewConfiguration.getScaledTouchSlop * (1 / 类似微博的emoji表情、@人、话题等);
     */
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                    + "of the ViewDragHelper'类似微博的emoji表情、@人、话题等 tracked parent view (" + mParentView + ")");
        }
     ...
     *
     * @param minLeft Minimum X position for the view'类似微博的emoji表情、@人、话题等 left edge
     * @param minTop  Minimum Y position for the view'类似微博的emoji表情、@人、话题等 top edge
     * @param maxLeft Maximum X position for the view'类似微博的emoji表情、@人、话题等 left edge
     * @param maxTop  Maximum Y position for the view'类似微博的emoji表情、@人、话题等 top edge
     */
     ...
     * (to the best of the ViewDragHelper'类似微博的emoji表情、@人、话题等 knowledge).
     * <p>
    ...
    /**
     * Check if this event as provided to the parent view'类似微博的emoji表情、@人、话题等
     ...
     * dispatch callback events as needed before returning. The parent view'类似微博的emoji表情、@人、话题等
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_UP: {
                ...
                if (mDragState == STATE_DRAGGING && pointerId == mActivePointerId) {
                    // Try to find another pointer that'类似微博的emoji表情、@人、话题等 still holding on to
                    // the captured view.
                    ...
                    for (int i = 0; i < pointerCount; i++) {
                        ...
                        if (id == mActivePointerId) {
                            // This one'类似微博的emoji表情、@人、话题等 going away, skip.
                            continue;
                        }
     ...
     * parent view'类似微博的emoji表情、@人、话题等 coordinate system. If there is no captured view this method
     * will return false.
     *
     * @param x X position to test in the parent'类似微博的emoji表情、@人、话题等 coordinate system
     * @param y Y position to test in the parent'类似微博的emoji表情、@人、话题等 coordinate system
     ...
     * view'类似微博的emoji表情、@人、话题等 coordinate system.
     *
    ...
    /**
     * Find the topmost child under the given point within the parent view'类似微博的emoji表情、@人、话题等
