...
/**
 * https://www.cnblogs.com/tianzhijiexian/p/4044402.html
...
public class AnimationViewPager extends ViewPager{
        ...
        public static final String TAG = "AnimationViewPager";
        ...
        public AnimationViewPager(Context context, AttributeSet attrs) {
            ...
            String[] transitions = getResources().getStringArray(R.array.animation_view_pager_effects);
