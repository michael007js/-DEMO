...
public final class FragmentUtils {
    ...
    public static boolean animationButton = true;
     ...
     * @return fragment
     */
    public static Fragment addFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
    ...
    public static Fragment addFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
        ...
        return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_ADD_FRAGMENT);
    }
    ...
    public static Fragment addFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
        ...
        putArgs(fragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_ADD_FRAGMENT, sharedElement);
    }
     ...
     * @return fragment
     */
    public static Fragment hideAddFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
        ...
        return operateFragment(withAnimation, fragmentManager, hideFragment, addFragment, TYPE_ADD_FRAGMENT, sharedElement);
    }
     ...
     * @return 要显示的fragment
     */
    public static Fragment addFragments(boolean withAnimation, @NonNull FragmentManager fragmentManager,
        ...
        for (int i = 0, size = fragments.size(); i < size; ++i) {
            ...
            if (fragment != null) {
                if (list != null) {
                    ...
                    return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_ADD_FRAGMENT, list.toArray(new SharedElement[0]));
                }
            }
        }
        return fragments.get(showIndex);
    ...
    public static void removeFragment(boolean withAnimation, @NonNull Fragment fragment) {
        operateFragment(withAnimation, fragment.getFragmentManager(), null, fragment, TYPE_REMOVE_FRAGMENT);
    }
    ...
    public static void removeToFragment(boolean withAnimation, @NonNull Fragment fragment, boolean isIncludeSelf) {
        operateFragment(withAnimation, fragment.getFragmentManager(), isIncludeSelf ? fragment : null, fragment, TYPE_REMOVE_TO_FRAGMENT);
    }
    ...
    public static void removeFragments(boolean withAnimation, @NonNull FragmentManager fragmentManager) {
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
            if (fragment != null) removeFragment(withAnimation, fragment);
        }
    }
     ...
     * @return 目标fragment
     */
    public static Fragment replaceFragment(boolean withAnimation, @NonNull Fragment srcFragment,
        ...
        return replaceFragment(withAnimation, srcFragment.getFragmentManager(), destFragment, containerId, isAddStack);
    }
    ...
    public static Fragment replaceFragment(boolean withAnimation, @NonNull Fragment srcFragment,
        ...
        int containerId = srcFragment.getArguments().getInt(ARGS_ID);
        if (containerId == 0) return null;
        return replaceFragment(withAnimation, srcFragment.getFragmentManager(), destFragment, containerId, isAddStack, sharedElement);
    }
     ...
     * @return fragment
     */
    public static Fragment replaceFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
                                           @NonNull Fragment fragment,
                                           @IdRes int containerId,
                                           boolean isAddStack) {
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_REPLACE_FRAGMENT);
    }
    ...
    public static Fragment replaceFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
                                           ...
                                           SharedElement... sharedElement) {
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_REPLACE_FRAGMENT, sharedElement);
    }
     ...
     * @return fragment
     */
    public static Fragment popAddFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
                                          @NonNull Fragment fragment,
                                          @IdRes int containerId,
                                          boolean isAddStack) {
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_POP_ADD_FRAGMENT);
    }
    ...
    public static Fragment popAddFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
        ...
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(withAnimation, fragmentManager, null, fragment, TYPE_POP_ADD_FRAGMENT, sharedElements);
    }
    ...
    public static Fragment hideFragment(boolean withAnimation, @NonNull Fragment fragment) {
        ...
        return operateFragment(withAnimation, fragment.getFragmentManager(), null, fragment, TYPE_HIDE_FRAGMENT);
    }
    ...
    public static void hideFragments(boolean withAnimation, @NonNull FragmentManager fragmentManager) {
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
            if (fragment != null) hideFragment(withAnimation, fragment);
        }
    }
    ...
    public static Fragment showFragment(boolean withAnimation, @NonNull Fragment fragment) {
        ...
        return operateFragment(withAnimation, fragment.getFragmentManager(), null, fragment, TYPE_SHOW_FRAGMENT);
    }
     ...
     * @return 显示的Fragment
     */
    public static Fragment hideShowFragment(boolean withAnimation, @NonNull Fragment hideFragment,
        ...
        return operateFragment(withAnimation, showFragment.getFragmentManager(), hideFragment, showFragment, TYPE_HIDE_SHOW_FRAGMENT);
    }
     ...
     * @return destFragment
     */
    private static Fragment operateFragment(boolean withAnimation, @NonNull FragmentManager fragmentManager,
