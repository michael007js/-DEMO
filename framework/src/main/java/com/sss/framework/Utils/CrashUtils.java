...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = FrameworkApplication.getContext()
                    .getPackageManager()
                    .getPackageInfo(FrameworkApplication.getContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && FrameworkApplication.getContext().getExternalCacheDir() != null)
            defaultDir = FrameworkApplication.getContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = FrameworkApplication.getContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
