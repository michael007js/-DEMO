...
import com.sss.framework.Model.ContactVo;
...
public final class PhoneUtils {
     ...
     * @return
     */
    public static List<ContactVo> getPhoneContacts(Context context,int pic) {
...
//                    continue;
                ...
                if (imgid > 0) {
                    ...
                    cv.setImg(BitmapFactory.decodeResource(context.getResources(),pic));
                }
