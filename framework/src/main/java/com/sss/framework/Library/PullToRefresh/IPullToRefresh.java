...
import com.sss.framework.Library.PullToRefresh.PullToRefreshBase.Mode;
import com.sss.framework.Library.PullToRefresh.PullToRefreshBase.OnPullEventListener;
import com.sss.framework.Library.PullToRefresh.PullToRefreshBase.OnRefreshListener;
import com.sss.framework.Library.PullToRefresh.PullToRefreshBase.OnRefreshListener2;
import com.sss.framework.Library.PullToRefresh.PullToRefreshBase.State;
...
public interface IPullToRefresh<T extends View> {
	 ...
	 * user'类似微博的emoji表情、@人、话题等 touch gesture (i.e. scrolled to the top/bottom).
	 * 
	 ...
	 * LoadingLayout(类似微博的emoji表情、@人、话题等) which will be affected, are chosen by the parameters you
	 * give.
	 * <p />
	 * You should not keep the result of this method any longer than you need
	 * it.
	 ...
	 * Android'类似微博的emoji表情、@人、话题等 standard Overscroll support (the edge-glow) which is available
	 * from GINGERBREAD onwards
	 * 
	 * @return true - if both PullToRefresh-OverScroll and Android'类似微博的emoji表情、@人、话题等 inbuilt
	 ...
	 * Android'类似微博的emoji表情、@人、话题等 standard Overscroll support (the edge-glow). This setting only
