...
public final class OverscrollHelper {
	 ...
	 * function.
	 * <p/>
	 * This should only be used on AdapterView'类似微博的emoji表情、@人、话题等 such as ListView as it just
	 * calls through to overScrollBy() with the scrollRange = 0. AdapterView'类似微博的emoji表情、@人、话题等
	 ...
	 * a Scroll Range but scroll back to it'类似微博的emoji表情、@人、话题等 edge correctly.
	 * 
	 * @param view - PullToRefreshView that is calling this.
	 * @param deltaX - Change in X in pixels, passed through from from
	 *            overScrollBy call
	 ...
	 *            doesn't always scroll back to it'类似微博的emoji表情、@人、话题等 edge. 0 = no fuzziness.
