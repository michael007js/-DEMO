...
import com.sss.framework.Library.PullToRefresh.internal.FlipLoadingLayout;
import com.sss.framework.Library.PullToRefresh.internal.FlipLoadingLayout_foot;
import com.sss.framework.Library.PullToRefresh.internal.LoadingLayout;
import com.sss.framework.Library.PullToRefresh.internal.RotateLoadingLayout;
import com.sss.framework.Library.PullToRefresh.internal.Utils;
import com.sss.framework.Library.PullToRefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * 
		 * @param refreshView
		 *            - View which has had it'类似微博的emoji表情、@人、话题等 state change.
		 * @param state
