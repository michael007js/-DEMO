package com.sss.framework.Library.OKHttp.cookie.store;
 ...
 * Cookies are stored and will persist on the user'类似微博的emoji表情、@人、话题等 device between application sessions since they
