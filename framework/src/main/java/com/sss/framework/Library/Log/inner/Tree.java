package com.sss.framework.Library.Log.inner;
...
import com.sss.framework.Library.Log.common.LogConvert;
...
public abstract class Tree implements ITree {
    ...
    private int getStackOffset(StackTraceElement[] trace, Class cla) {
        for (int i = LogConstant.MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (cla.equals(LogUtils.class) && i < trace.length - 1 && trace[i + 1].getClassName()
